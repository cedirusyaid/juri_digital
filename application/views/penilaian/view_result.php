        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url('penilaian'); ?>">Penilaian Saya</a></li>
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Hasil Penilaian untuk: <?php echo $entry['nama_karya']; ?> (Kompetisi: <?php echo $kompetisi['nama']; ?>)</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <strong><i class="fas fa-file-alt mr-1"></i> Nama Karya</strong>
                <p class="text-muted">
                ...
                <hr>
                <strong><i class="fas fa-image mr-1"></i> Tangkapan Layar</strong>
                <p class="text-muted">
                ...
                <strong><i class="fas fa-clipboard-check mr-1"></i> Status Penilaian</strong>
                <p class="text-muted">
                    <?php
                        $status_class = '';
                ...
                <h4>Kriteria Penilaian (Templat: <?php echo $template['nama_templat']; ?>)</h4>
                                                ...
                                                <?php if (!empty($indikator['sub_indikator_kriteria'])): ?>
                                                    <?php foreach ($indikator['sub_indikator_kriteria'] as $sub_indikator): ?>
                                                        <div class="form-group">
                                                            <label><?php echo $sub_indikator['nama']; ?> (Urutan: <?php echo $sub_indikator['urutan_tampil']; ?>)</label>
                                                            <p class="text-muted">Skor: <strong><?php echo $sub_indikator['skor']; ?></strong></p>
                                                            <p class="text-muted">Komentar: <em><?php echo $sub_indikator['catatan']; ?></em></p>
                                                        </div>
                                                    <?php endforeach; ?>
                                                <?php else: ?>
                                                    <p class="text-muted">Tidak ada sub-indikator yang ditentukan untuk indikator ini.</p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
              ...
              <div class="card-footer">
                <a href="<?php echo base_url('penilaian'); ?>" class="btn btn-secondary">Kembali ke Penilaian Saya</a>
                <?php if ($assessment['status'] == 'draft'): ?>
                    <a href="<?php echo base_url('penilaian/assess/' . $kompetisi['id'] . '/' . $entry['id']); ?>" class="btn btn-primary">Ubah Penilaian</a>
                <?php endif; ?>
              </div>
            </div>
            <!-- /.card -->
