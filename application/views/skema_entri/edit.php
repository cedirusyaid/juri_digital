    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="<?php echo base_url('skema_entri/index/' . $field['id_templat_penilaian']); ?>">Manage Schema</a></li>
          ...
          <?php echo form_open('skema_entri/edit/' . $field['id']); ?>
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="label_field" name="label_field" value="<?php echo set_value('label_field', $field['label_field']); ?>" placeholder="e.g., URL Website" required>
              </div>

              <div class="form-group">
                <label for="nama_field">Field Name (Key)</label>
                <input type="text" class="form-control" id="nama_field" name="nama_field" value="<?php echo set_value('nama_field', $field['nama_field']); ?>" placeholder="e.g., url_website (no spaces, lowercase)" required>
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="tipe_field" name="tipe_field">
                  <option value="text" <?php echo set_select('tipe_field', 'text', $field['tipe_field'] == 'text'); ?>>Text</option>
                  ...
                  <option value="number" <?php echo set_select('tipe_field', 'number', $field['tipe_field'] == 'number'); ?>>Number</option>
                </select>
              </div>
            ...
            <div class="card-footer">
              ...
              <a href="<?php echo base_url('skema_entri/index/' . $field['id_templat_penilaian']); ?>" class="btn btn-secondary">Cancel</a>
            </div>
          <?php echo form_close(); ?>
        </div>
        <!-- /.card -->
