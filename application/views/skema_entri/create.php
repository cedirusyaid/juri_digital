    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="<?php echo base_url('skema_entri/index/' . $id_templat_penilaian); ?>">Kelola Skema</a></li>
          <li class="breadcrumb-item active">Tambah Field</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
      ...
      <div class="col-md-12">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Tambah Field Baru ke `<?php echo $template['nama_templat']; ?>`</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <?php echo form_open('skema_entri/create/' . $id_templat_penilaian); ?>
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="label_field" name="label_field" value="<?php echo set_value('label_field'); ?>" placeholder="contoh: URL Website" required>
              </div>

              <div class="form-group">
                <label for="nama_field">Nama Field (Kunci)</label>
                <input type="text" class="form-control" id="nama_field" name="nama_field" value="<?php echo set_value('nama_field'); ?>" placeholder="contoh: url_website (tanpa spasi, huruf kecil)" required>
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="tipe_field" name="tipe_field">
                  <option value="text" <?php echo set_select('tipe_field', 'text', TRUE); ?>>Teks</option>
                  ...
                  <option value="number" <?php echo set_select('tipe_field', 'number'); ?>>Angka</option>
                </select>
              </div>
            ...
            <div class="card-footer">
              ...
              <a href="<?php echo base_url('skema_entri/index/' . $id_templat_penilaian); ?>" class="btn btn-secondary">Batal</a>
            </div>
          <?php echo form_close(); ?>
        </div>
        <!-- /.card -->
