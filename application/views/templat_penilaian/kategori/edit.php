          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Category: <?php echo $kategori['nama']; ?></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <?php echo form_open('templat_penilaian/kategori_edit/' . $template['id'] . '/' . $kategori['id']); ?>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo set_value('nama', $kategori['nama']); ?>" placeholder="Enter category name" required>
                  </div>
                  <div class="form-group">
                    <label for="bobot">Weight</label>
                    <input type="number" step="0.01" class="form-control" id="bobot" name="bobot" value="<?php echo set_value('bobot', $kategori['bobot']); ?>" placeholder="Enter weight (e.g., 0.5)" required>
                  </div>
                </div>
                <!-- /.card-body -->
