        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Create Sub-Indicator</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Create New Sub-Indicator for <?php echo $indikator['nama']; ?></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <?php echo form_open('templat_penilaian/sub_indikator_create/' . $template['id'] . '/' . $kategori['id'] . '/' . $indikator['id']); ?>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo set_value('nama'); ?>" placeholder="Enter sub-indicator name" required>
                  </div>
                  <div class="form-group">
                    <label for="urutan_tampil">Display Order</label>
                    <input type="number" class="form-control" id="urutan_tampil" name="urutan_tampil" value="<?php echo set_value('urutan_tampil'); ?>" placeholder="Enter display order">
                  </div>
                </div>
                <!-- /.card-body -->
