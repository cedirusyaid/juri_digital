          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Ubah Indikator: <?php echo $indikator['nama']; ?></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <?php echo form_open('templat_penilaian/indikator_edit/' . $template['id'] . '/' . $kategori['id'] . '/' . $indikator['id']); ?>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo set_value('nama', $indikator['nama']); ?>" placeholder="Masukkan nama indikator" required>
                  </div>
                  <div class="form-group">
                    <label for="bobot">Bobot</label>
                    <input type="number" step="0.01" class="form-control" id="bobot" name="bobot" value="<?php echo set_value('bobot', $indikator['bobot']); ?>" placeholder="Masukkan bobot (contoh: 0.5)" required>
                  </div>
                </div>
                <!-- /.card-body -->
